# Generated by Django 4.0.2 on 2022-03-02 16:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookPhoto', models.ImageField(blank=True, null=True, upload_to='photos')),
                ('authorPhoto', models.ImageField(blank=True, null=True, upload_to='photos')),
                ('pages', models.IntegerField(blank=True, null=True)),
                ('price', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('rentPricePerDay', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
